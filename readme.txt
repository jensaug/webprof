 ...
 This will deploy two artifacts, target/webprof.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/webprof.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/webprof.war

 To undeploy the application, run:

  ./asadmin undeploy webprof
